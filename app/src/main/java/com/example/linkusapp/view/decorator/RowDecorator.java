...
public class RowDecorator implements DayViewDecorator {

    private CalendarDay date;
    private final Calendar calendar = Calendar.getInstance();
    Context context;
    public RowDecorator(Date value, Context context) {
    ...
    public void decorate(DayViewFacade view) {
        ...
        view.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.cal_state_row));
