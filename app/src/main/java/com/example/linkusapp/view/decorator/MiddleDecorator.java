...
public class MiddleDecorator implements DayViewDecorator {

    private CalendarDay date;
    private final Calendar calendar = Calendar.getInstance();
    Context context;
    public MiddleDecorator(Date value, Context context) {
    ...
    public void decorate(DayViewFacade view) {
        ...
        view.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.cal_state_middle));
